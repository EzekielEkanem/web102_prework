...
// remove all styles in the children of a parent element
function deleteStyleElements(parent) {
    const parentChild = parent.children;
    for (let i = 0; i < parentChild.length; i++) {
        parentChild[i].removeAttribute("style");
    }
}
...
function filterUnfundedOnly() {
    ...
    deleteStyleElements(buttonContainer);
    ...
    //changes the color of the button to show that the button has been clicked
    unfundedBtn.style.backgroundImage = "linear-gradient(to right, #295182, #36577f)";
}
...
function filterFundedOnly() {
    ...
    //changes the color of the button to show that the button has been clicked
    fundedBtn.style.backgroundImage = "linear-gradient(to right, #295182, #36577f)";
}
...
function showAllGames() {
    ...
    //changes the color of the button to show that the button has been clicked
    allBtn.style.backgroundImage = "linear-gradient(to right, #295182, #36577f)";
}
...
const numOfUnfundedGames = listOfUnfundedGames.reduce( (acc, game) => {
    return acc + 1;
}, 0);
